 ...
 * Trigger: EventBridge cron diario 8:00 AM (ver iac/cloudwatch.tf ->
 * aws_cloudwatch_event_rule.control_plazos_schedule)
 *
 * Responsabilidad:
 *  - Revisar reclamos abiertos/en proceso cuyo SLA esta por vencer o vencio
 *  - Publicar alertas normales (SNS_TOPIC_ALERTS) y urgentes (SNS_TOPIC_URGENT)
 *    para reclamos ALTA prioridad ya vencidos
 */
